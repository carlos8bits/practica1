...
public class principal extends javax.swing.JFrame {
    ...
    {
        BigInteger fact =  Permutar.getFactorial(n);
        BigInteger d = new BigInteger("400000");
        int size = Integer.parseInt((fact.divide(d)).toString());
        int[] s = new int[size];
    ...
    public void Dibujar(LSLCNC lst, TextArea objTxt, JLabel lblGrafica, String hileraingresada) {
        ...
        objTxt.setText(null);
        if (hileraingresada.length() >= 10) {
            int[] s = array(hileraingresada.length());
            BigInteger fact =  new Permutar().getFactorial(hileraingresada.length());
            
            if (hileraingresada.length() > 0) {
                buffer.append("LA HILERA INGRESADA ES : \"" + hileraingresada + "\"");
                buffer.append("\n");
                buffer.append("\n");
                buffer.append("\n");
            }
            ...
            while (!lst.finDeRecorrido(p)) {
                try {
                    count++;
                    buffer.append(p.retornaPermutacion());
                    buffer.append("\t");
                   ...
                   Thread.sleep(time);
                    ...
                    if(count%400000==0)
                    {
                        objTxt.append(buffer.toString());
                       lblGrafica.setText(Objects.toString(count)+ " de "+ fact );
            ...
            objTxt.setText(buffer.toString());
            lblGrafica.setText(Objects.toString(count));
        }
    }
    ...
    private void ingresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ingresarActionPerformed
        ...
        txtGrafica2.setText(null);
        if (hilera.length() > 0) {
            objHilera = hilera;
            objHileraIngresada = hilera;
